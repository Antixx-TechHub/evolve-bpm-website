<template>
    <div class="about-area pb-100">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="about-content">
                        <div class="text">
                            ...
                            <NuxtLink to="about-two" class="default-btn">More About Us</NuxtLink>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="shape15"><img src="~/assets/images/shape/shape15.png" alt="image"></div>
    </div>
</template>
