            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12">
                    <div class="feedback-image">
                        <img src="~/assets/images/feedback-img1.jpg" alt="image">
                        <img src="~/assets/images/feedback-img2.jpg" alt="image">
                        <img src="~/assets/images/feedback-img3.jpg" alt="image">
                        <img src="~/assets/images/feedback-img4.jpg" alt="image">
                    </div>
                </div>
