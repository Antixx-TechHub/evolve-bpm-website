                    ...
                    <div class="timeline-content">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5 col-md-12">
                                <div class="image">
                                    <img src="~/assets/images/history/history-img1.jpg" alt="image">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <li class="timeline-block">
                    ...
                    <div class="timeline-content">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5 col-md-12">
                                <div class="image">
                                    <img src="~/assets/images/history/history-img2.jpg" alt="image">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <li class="timeline-block">
                    ...
                    <div class="timeline-content">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5 col-md-12">
                                <div class="image">
                                    <img src="~/assets/images/history/history-img3.jpg" alt="image">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <li class="timeline-block">
                    ...
                    <div class="timeline-content">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5 col-md-12">
                                <div class="image">
                                    <img src="~/assets/images/history/history-img4.jpg" alt="image">
                                </div>
                            </div>
                        </div>
                    </div>
