            ...
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <div class="terms-of-service-content">
                        ...
                        <h3>1. Our website</h3>
                        <p>Our website address is: <strong>http://rivate.com</strong></p>
                ...
                <div class="col-lg-4 col-md-12">
                    <aside class="widget-area">
                        <section class="widget widget_insight">
                            <ul>
                                <li><NuxtLink to="/about-one">About Us</NuxtLink></li>
                                <li><NuxtLink to="/contact">Contact Us</NuxtLink></li>
                                <li><NuxtLink to="/privacy-policy">Privacy Policy</NuxtLink></li>
                                <li class="active"><NuxtLink to="/terms-of-service">Terms of Service</NuxtLink></li>
                            </ul>
                        </section>
                    </aside>
                </div>
