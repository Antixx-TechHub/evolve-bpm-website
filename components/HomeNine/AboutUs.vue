<template>
    <div class="rivate-about-area ptb-100">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12">
                    <div class="rivate-about-image">
                        <img src="~/assets/images/more-home/about/about-2.png" alt="image">
                    </div>
                </div>

                <div class="col-lg-6 col-md-12">
                    <div class="rivate-about-content">
                        <span>ABOUT US</span>
