                ...
                <div class="row align-items-center">
                    <div class="col-lg-5 col-md-12">
                        <div class="products-details-image">
                            <img src="~/assets/images/products/products-img1.jpg" alt="image">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 col-md-12">
                        <div class="products-details-desc">
                            ...
                            <div class="products-meta">
                                ...
                                <span>Category: <NuxtLink to="/products-list">Business</NuxtLink></span>
                                <span>Tag: <NuxtLink to="/products-list">Book</NuxtLink></span>
                            </div>

                            <div class="products-add-to-cart">
                                <div class="input-counter">
                                    <span @click="decreaseQuantity()" class="minus-btn"><i class='bx bx-minus'></i></span>
                                    {{quantity}}
                                    <span @click="increaseQuantity()" class="plus-btn"><i class='bx bx-plus'></i></span>
                                </div>

                                <button v-if="getExistPId" type="submit" class="default-btn" @click="addToCart()">
                                    Already Added
                                </button>

                                <button v-else type="submit" class="default-btn" @click="addToCart()">
                                    Add to Cart
                                </button>
                            </div>
                            ...
                            <div class="products-share">
                                <ul class="social">
                                    ...
                                    <li><a href="https://twitter.com/" class="twitter" target="_blank"><i class='bx bxl-twitter'></i></a></li>
                                    <li><a href="https://www.linkedin.com/" class="linkedin" target="_blank"><i class='bx bxl-linkedin'></i></a></li>
                                    <li><a href="https://www.youtube.com/" class="instagram" target="_blank"><i class='bx bxl-instagram'></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <b-tab title="Description">
                                                <div class="tabs_item">
                                                    <div class="products-details-tab-content">
                                                        ...
                                                        <ul>
                                                            <li>Instant Rivate bestseller</li>
                                            ...
                                            <b-tab title="Reviews (2)">
                                                <div class="tabs_item">
                                                    ...
                                                    <div class="products-review-comments">
                                                        ...
                                                        <div class="user-review">
                                                            <img src="~/assets/images/user4.jpg" alt="image">
                                                            <div class="review-rating">
                                                                <div class="review-stars">
                                                                    <i class='bx bxs-star checked'></i>
                                                                    <i class='bx bxs-star checked'></i>
