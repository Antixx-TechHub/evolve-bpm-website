            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="pagination-area text-center">
                        <a href="/services-two" class="prev page-numbers"><i class='bx bx-chevrons-left'></i></a>
                        <span class="page-numbers current" aria-current="page">1</span>
                        <a href="/services-two" class="page-numbers">2</a>
                        <a href="/services-two" class="page-numbers">3</a>
                        <a href="/services-two" class="page-numbers">4</a>
                        <a href="/services-two" class="next page-numbers"><i class='bx bx-chevrons-right'></i></a>
                    </div>
                </div>
            </div>
        </div>
