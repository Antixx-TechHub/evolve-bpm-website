                    ...
                    <div class="blog-details-desc">
                        <div class="article-image-slides owl-carousel owl-theme">
                            <carousel
                                ...
                                navigationNextLabel="<i class='flaticon-chevron'></i>"
                        ...
                        <div class="article-content">
                            ...
                            <ul class="wp-block-gallery columns-3">
                                <li class="blocks-gallery-item">
                                    <figure>
                                        <img src="~/assets/images/blog/blog-img4.jpg" alt="image">
                                    </figure>
                                </li>

                                <li class="blocks-gallery-item">
                                    <figure>
                                        <img src="~/assets/images/blog/blog-img5.jpg" alt="image">
                                    </figure>
                                </li>

                                <li class="blocks-gallery-item">
                                    <figure>
                                        <img src="~/assets/images/blog/blog-img6.jpg" alt="image">
                                    </figure>
                                </li>
                            </ul>
                        ...
                        <div class="article-footer">
                            ...
                            <div class="article-share">
                                <ul class="social">
                                    ...
                                    <li><a href="https://www.facebook.com/" class="facebook" target="_blank"><i class='bx bxl-facebook'></i></a></li>
                                    <li><a href="https://www.twitter.com/" class="twitter" target="_blank"><i class='bx bxl-twitter'></i></a></li>
                                    <li><a href="https://www.linkedin.com/" class="linkedin" target="_blank"><i class='bx bxl-linkedin'></i></a></li>
                                    <li><a href="https://www.instagram.com/" class="instagram" target="_blank"><i class='bx bxl-instagram'></i></a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="article-author">
                            ...
                            <div class="author-profile">
                                <div class="author-profile-title">
                                    <img src="~/assets/images/user1.jpg" class="shadow-sm" alt="image">
                                    <h4>Chris Orwig</h4>
                                ...
                                <div class="info-prev-link-wrapper">
                                    <NuxtLink to="/blog-details-one">
                                        ...
                                        <span class="prev-link-info-wrapper">
                                            <span class="prev-title">Digital Marketing Strategies for Lead Generation</span>
                                            <span class="meta-wrapper">
                                                <span class="date-post">Jun 20, 2021</span>
                                            </span>
                                        </span>
                                    </NuxtLink>
                                </div>
                                ...
                                <div class="info-next-link-wrapper">
                                    <NuxtLink to="/blog-details-one">
                                        <span class="next-link-info-wrapper">
                                            <span class="next-title">Agencies Can Successfully Recover From COVID?</span>
                                            <span class="meta-wrapper">
                                                <span class="date-post">Jun 19, 2021</span>
                                            </span>
                                        </span>
                            ...
                            <ol class="comment-list">
                                    ...
                                    <div class="comment-body">
                                        <footer class="comment-meta">
                                            <div class="comment-author vcard">
                                                <img src="~/assets/images/user1.jpg" class="avatar" alt="image">
                                    ...
                                    <ol class="children">
                                        <li class="comment">
                                            <div class="comment-body">
                                                <footer class="comment-meta">
                                                    <div class="comment-author vcard">
                                                        <img src="~/assets/images/user2.jpg" class="avatar" alt="image">
                                            ...
                                            <ol class="children">
                                                <li class="comment">
                                                    <div class="comment-body">
                                                        <footer class="comment-meta">
                                                            <div class="comment-author vcard">
                                                                <img src="~/assets/images/user3.jpg" class="avatar" alt="image">
                                ...
                                <li class="comment">
                                    <div class="comment-body">
                                        <footer class="comment-meta">
                                            <div class="comment-author vcard">
                                                <img src="~/assets/images/user4.jpg" class="avatar" alt="image">
