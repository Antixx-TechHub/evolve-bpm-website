<template>
  <div>
    <Navbar />
    <PageTitle pageTitle="Featured Blog Category" pageDesc="" />
  ...
  methods: {
    async fetchCategories() {
      try {
        ...
        const reaponse = await axios.get(`https://evolvestrapi.pbwebvision.in/api/featured-categories?filters[slug][$eq]=${slug}&populate=deep,5`, { params: { slug } })
